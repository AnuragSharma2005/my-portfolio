...
import { BookOpen, Users, Workflow, Rocket } from "lucide-react" // icons
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-screen-xl bg-[#111827] rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.2)] p-8 md:p-12 relative z-10">
        {/* Header Section */}
        <div
          className={`mb-16 ${isVisible ? "animate-slide-in-up" : "opacity-0"}`}
        >
          <div className="flex items-center gap-6 mb-8">
            {/* Profile Photo */}
            <div className="relative">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-accent to-accent/60 p-1 animate-float">
                <img
              ...
              <div className="absolute inset-0 w-24 h-24 border-2 border-accent/30 rounded-full animate-spin-slow"></div>
            </div>

            {/* Header Text */}
            <div>
              <h1 className="text-4xl font-bold mb-2">Startup Journey</h1>
            ...
            <a
                ...
                className="text-accent font-mono text-sm animate-typewriter hover:underline"
            >
                mokshdigital.app
            </a>
            </div>
            ...
            >
              ...
              <div className="relative bg-card border border-border rounded-xl p-8 transition-all duration-500 hover:border-accent/50 hover:shadow-2xl hover:shadow-accent/10 hover:scale-[1.02]">
                ...
                <div className="grid md:grid-cols-3 gap-8 items-start relative z-10">
                  ...
                  {/* Empty Middle Column (Removed Paragraph Here) */}
                  <div></div>
                    ...
                    <div className="relative w-32 h-32">
                      <div
                        className={`absolute inset-0 rounded-full bg-accent/10 transition-all duration-500 ${
                          activeCard === startup.id
                            ? "scale-110 bg-accent/20"
                            : ""
                        }`}
                      ></div>
